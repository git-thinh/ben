...
namespace test_mini
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //CefExample.Init(_CONST.CEF_SETTINGS, browserProcessHandler: new BrowserProcessHandler());
        ...
        private static async void MainAsync(string cachePath, double zoomLevel)
        {
            ...
            using (var browser = new ChromiumWebBrowser(_CONST.URL, browserSettings, requestContext))
            {
                if (zoomLevel > 1)
                {
