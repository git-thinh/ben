...
namespace test_mini
{
    public class app2
    {
        ...
        public static int Main222(string[] args)
        {
            ...
            CefExample.Init(new CefSettings()
            {
                ResourcesDirPath = rootPath,
                LocalesDirPath = Path.Combine(rootPath, "locales"),
                BrowserSubprocessPath = rootPath,
